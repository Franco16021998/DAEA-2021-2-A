...
namespace Lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarCursoNombre_Result> BuscarCursoNombre(string title)
        {
            var titleParameter = title != null ?
                new ObjectParameter("Title", title) :
                new ObjectParameter("Title", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarCursoNombre_Result>("BuscarCursoNombre", titleParameter);
        }
        ...
        public virtual int InsertCourse(Nullable<int> courseID, string title, Nullable<int> credits, Nullable<int> departmentID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertCourse", courseIDParameter, titleParameter, creditsParameter, departmentIDParameter);
        }
        ...
        public virtual int UpdateCourse(Nullable<int> courseID, string title, Nullable<int> credits, Nullable<int> departmentID)
        {
            var courseIDParameter = courseID.HasValue ?
                new ObjectParameter("CourseID", courseID) :
                new ObjectParameter("CourseID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateCourse", courseIDParameter, titleParameter, creditsParameter, departmentIDParameter);
        }
